...
mod tests {
    ...
    fn parse_resp() {
        ...
        let number_str = ":100\r\n";
        assert_eq!(unpack(number_str.to_string()), Ok(resp::Value::Integer(100)));

        let number_str = ":-99\r\n";
        assert_eq!(unpack(number_str.to_string()), Ok(resp::Value::Integer(-99)));

        let number_str = ":+98\r\n";
        assert_eq!(unpack(number_str.to_string()), Ok(resp::Value::Integer(98)));

        let map_str = "%5\r\n+name\r\n+xiamingjie\r\n$5\r\nhello\r\n$5\r\nworld\r\n:1\r\n+1\r\n+array\r\n*1\r\n+item1\r\n+map\r\n%1\r\n+map_k\r\n+map_v\r\n";
        assert_eq!(unpack(map_str.to_string()), Ok(resp::Value::Map(HashMap::from([
        ...
        assert_eq!(unpack("~2\r\n:1\r\n+xiamingjie\r\n".to_string()), Ok(resp::Value::Set(HashSet::from([resp::Value::Integer(1), resp::Value::SimpleStr("xiamingjie".to_string())]))));
    }
    ...
    #[test]
    fn pack() {
        assert_eq!(resp::pack(resp::Value::SimpleStr(String::from("hello"))), "+hello\r\n");
        assert_eq!(resp::pack(resp::Value::Error(String::from("Error: redis nil"))), "-Error: redis nil\r\n");
        assert_eq!(resp::pack(resp::Value::BulkStr(String::from("hello"))), "$5\r\nhello\r\n");
        assert_eq!(resp::pack(resp::Value::Integer(99999)), ":99999\r\n");
        assert_eq!(resp::pack(resp::Value::Bool(true)), "#t\r\n");
        assert_eq!(resp::pack(resp::Value::Array(vec![resp::Value::BulkStr(String::from("hello")), resp::Value::Integer(123456)])), "*2\r\n$5\r\nhello\r\n:123456\r\n");
        assert_eq!(resp::pack(resp::Value::Map(HashMap::from([(resp::Value::SimpleStr(String::from("abc")), resp::Value::Array(vec![resp::Value::BulkStr(String::from("hello")), resp::Value::Integer(123456)]))]))), "%1\r\n+abc\r\n*2\r\n$5\r\nhello\r\n:123456\r\n");
